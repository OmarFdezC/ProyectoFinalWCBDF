    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/api/v1/inventory/**").hasAuthority("READ");
                    auth.requestMatchers(HttpMethod.POST, "/api/v1/inventory/**").hasAuthority("CREATE");
                    auth.requestMatchers(HttpMethod.PUT, "/api/v1/inventory/**").hasAuthority("UPDATE");
                    auth.requestMatchers(HttpMethod.DELETE, "/api/v1/inventory/**").hasAuthority("DELETE");
